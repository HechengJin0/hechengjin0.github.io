...
### Bio
I’m Jin, a PhD candidate in Bioengineering at the [University of Pittsburgh](https://rf-research-facility.engineering.pitt.edu/), specializing in **RF design, EM simulation, and hardware bring-up & debug**. My PhD research focuses on the development of high-density RF antenna arrays for ultra-high-field systems (7T MRI). I have designed and delivered a 60-channel dual-band (300MHz/120MHz) RF system, owning the entire lifecycle from initial FDTD EM modeling and physical prototyping to final human-subject validation. I specialized in optimizing large-scale antenna arrays to ensure high field homogeneity and signal integrity in complex environments.
...
### Hardware & Simulation
- Designed and engineered high-density, dual-tuned ([300MHz/120MHz](/assets/abstract/ISMRM2025_31Pcoil_download.pdf)) RF transmit & receive antenna arrays  for 7T MRI.
